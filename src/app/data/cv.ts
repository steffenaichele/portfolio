...
// Inhalte liegen typisiert hier statt in messages/*.json: strukturierte Daten
// sind kein UI-Text. messages/*.json trägt nur noch Überschriften und Labels.
...
export const experience: CVEntry[] = [
	{
		...
		roles: [
			{
				title: "UX/UI Designer & Fullstack Developer",
				startMonth: "Mar",
				startYear: 2025,
				endMonth: "Dec",
				endYear: 2025,
		...
		descriptionShort: "Solo project: Replaced a legacy Adobe Flash exhibit with an offline-capable Electron desktop app built in React, TypeScript and Tailwind CSS. End-to-end ownership from UX/UI concept to deployment.",
		technologies: [
			"React",
			"TypeScript",
			"Electron",
	...
	},
	{
		...
		location: "Stuttgart",
		organizationLink: "https://futureforms.studio",
		roles: [
			{
		...
		description: [
			...
			"Independently led a client project over several months in a team of 3: workshop planning and facilitation, user research, wireframing, usability testing, building a design system and presenting results to the client.",
			"Built an internal wireframe UI library in Figma with 30+ reusable components — used team-wide to accelerate the wireframing process.",
		...
		descriptionShort: "Independently led client projects from research and wireframing through usability testing to building a design system. Created an internal Figma UI library with 30+ reusable components.",
		technologies: [
			"Figma",
			"Design Systems",
			"Wireframing",
	...
	},
	{
		...
		location: "Stuttgart",
		organizationLink: "https://www.halbautomaten.studio/",
		roles: [
			{
		...
		descriptionShort: "Contributed to client projects in corporate design, web design and print media. Designed and built the agency's new website and templates for digital versions of print media.",
		technologies: [
			"Figma",
			"SquareSpace",
			"Visual Design",
	...
	},
	{
		...
		location: "Stuttgart",
		organizationLink: "https://amplifydesign.eu/",
		roles: [
			{
		...
		descriptionShort: "Redesign of a B2B software (user flows, wireframes, visual design). Contributed to a design system with interactive style guide and UI library. 3D modelling in Cinema 4D and mentoring of interns.",
		technologies: [
			"Figma",
			"Cinema 4D",
			"Design Systems",
		...
		totalDuration: "2 years 11 months",
		totalStartMonth: "Oct",
		totalStartYear: 2018,
		totalEndMonth: "Sep",
		totalEndYear: 2021,
	},
	{
		...
		location: "Stuttgart",
		organizationLink: "https://paperdice.de/",
		roles: [
			{
		...
		descriptionShort: "Designed and refined print products for several brands and locations. Co-developed a brand identity and produced a comprehensive style guide.",
		technologies: [
			"Adobe CC",
			"Visual Design",
		],
		totalDuration: "1 year 1 month",
		totalStartMonth: "Aug",
		totalStartYear: 2017,
		totalEndMonth: "Sep",
		totalEndYear: 2018,
...
export const education: CVEntry[] = [
	{
		...
		organisationInitials: "WBS",
		location: "Berlin",
		organizationLink: "https://www.wbscodingschool.com/de/",
		roles: [
			{
	...
	},
	{
		...
		organizationShort: "Hochschule für Gestaltung",
		organisationInitials: "HfG",
		location: "Schwäbisch Gmünd",
		organizationLink: "https://www.hfg-gmuend.de/",
		roles: [
			{
	...
	},
	{
		...
		organisationInitials: "JGS",
		location: "Stuttgart",
		organizationLink: "https://www.jgs-stuttgart.de/",
		roles: [
			{
	...
	},
	{
		...
		organizationShort: "Gewerbliche Schule",
		organisationInitials: "GSGD",
		location: "Schwäbisch Gmünd",
		organizationLink: "https://www.gs-gmuend.de/aktuelles.html",
		roles: [
			{
		...
		totalDuration: "3 years 10 months",
		totalStartMonth: "Sep",
		totalStartYear: 2012,
		totalEndMonth: "Jul",
		totalEndYear: 2016,
