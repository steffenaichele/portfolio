		...
		<footer className="col-start-1 xl:col-start-2 -col-end-1 xl:-col-end-2 w-full bg-(--bg-footer) xl:rounded-3xl xl:my-4 px-8 py-10">
			<div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-8">
				<div className="flex flex-col gap-2">
					<span className="text-(--text-inverted) font-medium text-lg">steffen aichele</span>
					<span className="label-sm text-(--text-tertiary)">UX/UI Designer & Full Stack Developer</span>
				</div>
				...
				<p className="label-sm text-(--text-tertiary)">
					© {new Date().getFullYear()} Steffen Aichele
				</p>
			</div>
		</footer>
	);
