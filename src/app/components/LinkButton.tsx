...
const LinkButton = ({
	...
	const baseClasses =
		"h-7 inline-flex flex-row items-center justify-center text-lg font-medium tracking-wide py-1 transition-[color,opacity] duration-150 select-none focus:outline-1 focus:outline-orange-300 focus:outline-offset-2 rounded";
